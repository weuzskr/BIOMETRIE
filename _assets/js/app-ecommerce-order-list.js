      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output = '<a href="app-ecommerce-order-details-demande-ministere.html"><span>#' + $order_id + '</span></a>';
            return $row_output;
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="app-ecommerce-order-details-demande-ministere.html" class="dropdown-item">View</a>' +
